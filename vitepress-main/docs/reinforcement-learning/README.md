...
![](assets/jy2mNsy7VghdulRKCDsqTGfPQ2iSRiLuejUiN6WN-gI=.png)

![](assets/xq60ZOSyjFoyWLD_xMX4oo63hzUi1f8HTOgXX04C6UY=.png)

![](assets/O3kLtdsr61MinRg1tEON770Tsk4FyKyNZ32Ya6V4-Fs=.png)

* Each row of this matrix tells us what will happen for each state that I was in. 

![](assets/Y0M9m0POc3YOSdKTu7zElBEGd986Z2o_C7k83VHfQpQ=.png)

![](assets/JklYONXY1HfHgo2gYmqQHvRUnZtKQmpJiiELrJgok4A=.png)
...
* Markov Reward Process.
  * It is the Markov process with some value judgement
  ![](assets/KJ4_814FoaXZP-iV81hJ1EaEiEm8mzF6FySQy1l2XCE=.png)

  ![](assets/NooKy-v31KcQGNp3scrcvIYDt8LPkK0tQECYB197-VU=.png)
  ...
  * For $\gamma$:
  ...
  ![](assets/JB0DYmVcDgqvdhk47Ora_m_MTKb_wrEQcBXVKEtUAAo=.png)

  ![](assets/9sx54gPzyQY0FZSd21jeB6Y7TMehLE_D6R7wkP7Gkew=.png)

  ![](assets/t_ryTthSDcB0lrwRS8AhQayWDQKhg3BhPAIw8teuGQM=.png)
  * Bellman equation may be the most fundamental relationship in RL
  ![](assets/AVqWdLy-fLy0Wp7W-NkOkU61DKs5z3JdCgC_uMbFWsE=.png)

  ![](assets/qtqnSExaLVoMTLDWnXb1Kz1LjR0HLBfOYmEeNcOemLA=.png)
...
* Policies
  ...
  * Our definition of state information-wise includes all the information about the expected future
  ![](assets/PQvN7aIBPl-TvXTr09-pwjdu1ceBP1TFs9hGSQPgn-8=.png)
* Value function

  ![](assets/QbbrGK_skmYy6ErIDZF_zVOwWZpemQFPuwUxN7gYNNA=.png)
  * state-value function
    * The $v_{\pi}(s)$ tells us how good is it to be in state s if I'm following policy $\pi$ 
  * action-value function
* Bellman Expectation Equation

  ![](assets/y2Ga0peaC_BjkZOh9VCNbvQO1EMpVQgo7rzcQssBfiw=.png)

  ![](assets/W7yOj4Z-nMDX133PMrrFmQdkmKR91I4hwugJW22fwBM=.png)
...
* Optimal Value Function
  ...
  ![](assets/sELtSZa1zTIl-lwf-YdOIb-fZJ6dVyVH1Yj6xkGx_aY=.png)

  ![](assets/fPYFClpTSfTMVNPDY65VYSX4HQbUKby9F1EwhWSar4o=.png)
* Optimal Policy

  ![](assets/WAlczpGO5vnpqmELYBrekdr3z1eBUt0-5yIkkLlI3uo=.png)

  ![](assets/pMUaBl9eWGqMbGCjWNJobbAtnAMnMiI602aDawvdBTA=.png)
  * &#x20;An optimal policy can be found by maximising over action-value function.

 

![](assets/KfQ5ntH6VhoW8EDI76YP1Ps-znm_tNd3C5bn-IVSMec=.png)
...
* The max of the q values can be achieved by picking up the max of values of each of the actions that you can take from that state.
  ...
  ![](assets/INhMq-P83Qh49Dx2MnFz6Uv_PbCCOix7yV3AmyXwX5Q=.png)

![](assets/Y2VIbgZfplInysm2KdQlboNpv5ZwwOVgXh6ueTZdaOM=.png)

![](assets/_GlFfQ0vD6dEvadbaviTD5lvRO7oUZ6cYuKI1tBiwSo=.png)

![](assets/In2OU8fUopZmZ7iQLDg_SVpK0LSvMZYcol4m1yHzIwc=.png)
...
![](assets/bvGwR9CnpimRl_JlHVbwJGLkkuTHxwXYFZjj70cfQbE=.png)

## Lecture3: Planning by Dynamic Programming

* Intro

  ![](assets/l7Y_cdM-KH9ACofd2aqGb0TOSPQP9uYCZBNRaYYvYOI=.png)

  ![](assets/klkIJkFBhdP8DY4Sg0iJZmmFuNN_Kf2hkH_V6VFjiDI=.png)
* Planning in an MDP

  ![](assets/8WxgnfGqOBQ9P16C1MBK1mxOJZp0LzNincob7OtkpvA=.png)
* What's a Dynamic Programming solving?

  ![](assets/Sd1Z4JUGPK-FnmpA4pGw1gFzpLD07gqPgHbrRhkRVnc=.png)
* Policy Evaluation

  ![](assets/JI1Wm1-n7rgVH3wQdvPYK7H_aFVG9TKp4k3TdJYkQms=.png)

  ![](assets/DY0uSLGDMOfNdybFRUPAQTrmlv1SJSwUBbhcldC_hs0=.png)
...
* Policy Iteration 
  ...
  ![](assets/L6pgh-V6eCxmCJpO_UpvDZsgy-gbO1MH6BnYW0XMJZI=.png)
  * There's always at least one deterministic optimal policy for any MDP, so it's sufficient to actually search over deterministic policies only when youre looking for the optimal policy. 
  ![](assets/YibS5PfsNsWYV0Idqhx68ZtZLS9J12B_a3hKo8IhzCU=.png)
  * No matter where you start for any value and any policy, you will always end up with the optimal value function and the optimal policy.
  ![](assets/_OfR7ygyXJcNInS7bdeySVKnbTJryIZ6Uc_U9o5uPUk=.png)
  ...
  * There's no cost in moving a car in this example.  
  ![](assets/s4O15U2AkSDl4detW9qxdmpr8QP0XanrurMc0KRulc8=.png)
...
* Value Iteration
  ...
  ![](assets/ynGTu8QXklc-mknmCWLQse-5VKMm60uyKBdm32NcKv0=.png)
  * &#x20;So if my first action is optimal and then after that I follow an optimal policy from wherever I end up then we can say that the overall behavior is optimal。
  ![](assets/u1UvzmsdT1FU1PfuQtCS7oWlC0Pi1oecU4LjwDxvwdQ=.png)

  ![](assets/X4-fndXKgwKYCLQdgQ85x0rY5crm1MHEadn-EQWNXmk=.png)

  [Artificial Intelligence: Foundations of Computational Agents
  &#x20; \-- Value Iteration Demonstration](https://www.cs.ubc.ca/~poole/demos/mdp/vi.html)

  ![](assets/kkPvS05Y5fof9gpN54IVCKMKvyXDXYdpepXtVV2K6vA=.png)
...
![](assets/vd8goaKE1lGtYl_K-87bqOLqO4HxXv0yEMfdgo7Xb_M=.png)

![](assets/dtVzEMW_tRV7X9Gy9RSLkSR5oLADJFwP2NlzTziAAJs=.png)

![](assets/P0R85GPMZMQuBwC48ZpwV9kssvgW8DVEMm_iFs3XTO0=.png)

![](assets/xbs0lF1LBI1C97QNkcelSGokyH-58x3ExnUDrE_s42g=.png)

![](assets/gXTNP7QyI0scCAANE05JDPLHAWwNentNnn-PEfLxHyc=.png)

![](assets/KsSFYn7cOdqL93cwPbjCRP4QXS5mDTOTjoNSZettvEo=.png)

![](assets/P4eDfELJJSzOEwx8Wd0vmnrxlFLk_aa8cTLV1gAC_5E=.png)

 

![](assets/dRf6ni4ihYkw-SQsEgPqATKhsevFHF7gTAlFs1uJVV4=.png)
...
![](assets/lgYVFM8VK6u0OKo6_B0yJ1ud5YVGSiGR25dXh7ouNwc=.png)

![](assets/T1X71BsxUWjs_91DQdXx_d9XWFOXqR1EHlTWS1W7598=.png)

![](assets/dZf2stApg9R7FsXZN-qolDmCsD0Bn3ZhKJ0iEaU-seU=.png)
...
![](assets/tKs0aD2N3FHxQrxkMQphFEYvkJ3UxtJWCceOWuq3MW4=.png)

* Sarsa: State-Action-Reward-State-Action

![](assets/Y71Ckfj0_hpIz95NQTYbsaF9930EEezYRY6NyzLnVL4=.png)

![](assets/aUSSicpxH0PwNa_FneTDxOlRETd_M4Yho3VDLx1a33k=.png)

![](assets/CN0f755dGWPB2UYPDb84JZ3BYj5y19OlLEULJysPQsw=.png)

![](assets/cukcY4O18TnsBtqlC-k6drSe9EsT5ThEmj1eRCFvDx4=.png)

![](assets/H7Brp-fLJKrjZ8XJkpDy1e_OcOGS_3lwU_09GSgpnPA=.png)

![](assets/ANptl6hi0OPgBPa9guUkd8VDznzh_cph1ziMX5phMvo=.png)

 

![](assets/mjPr8MhDVWzy05Ty_SmWH0JFgmXWgc9O4E9asaFbM60=.png)
...
![](assets/SzornyJmEjc5pfG0JBta45tMzqIbP-2uPBcgVepMezU=.png)

![](assets/sAfUcPZnPYrS1Li_E5wQNiAd3S5MxWKRHl5XIO9xTVQ=.png)

![](assets/qLDPH5lMzBFJSYJMafjFYtkj-G3lLUhOHNujXWQ_xqs=.png)

> https://chat.qwen.ai/s/t\_53c20bd8-dfc6-4204-886f-74ecba03690f?fev=0.1.9

![](assets/lGaMCMc4WJx-LAXtmCAxhrwCR7NMBnuaINUEI1rn46k=.png)

![](assets/ALpOttHB3YPlCn7A3Ikpnz1o-bCXkPsx4ZsLn2sHrzE=.png)
...
![](assets/ACFnYSTTJ8R389adr1wkIa0LjA30fetIKXTZolIDrf0=.png)

![](assets/OLko43tpCcsCBxlhbM9nGCKy4OX_o22-wjPt9OTljaw=.png)

![](assets/PTLtodqdKSFVMEu7nD0lX8wCeD3UNahISDajantmq6I=.png)

 

![](assets/duvh32ekKNnJujf3x-e7XDYBQYN_4mGeYZf9jfOSRMQ=.png)

![](assets/gOp0HOXzeuvBnT1qGmX-gKxwSiLVxxW4xmFV_AdZXjQ=.png)

## Lecture6: Value Function Approximation

### Introduction

![](assets/EnrMNo0rbQRSV6YFW5hbtahlBldXF1gduHCyCs3ZyXc=.png)
...
![](assets/P3G-BbexoQfphTjM7gNItFNxbOzXP5exdirf21IiDuk=.png)

* Consider this action here, how could that be?

![](assets/tthvMh_samWNK2AiRWBrItoHYUtlvwYe5C7tqG0vDR4=.png)

![](assets/D-_pGqbccloxOmqrOos36tliAUhoMo466cyIfPp5v8Y=.png)
...
![](assets/R28W3mX6Udr2GNoPB8-CEVON_JIZ33m2hLcOzQq-Gj8=.png)

![](assets/UT-h5oOn36Bk9v5nordHsFtu-zucyn20Oobbq85Udj4=.png)

![](assets/XX9Vu-FtrI24ia48_9ji6Nix5QmnRqaJm406hAHBE_Q=.png)
...
![](assets/0lrmoEXUlAD4v5xCQpm6VaW58dm4NNx0HrmP6JngXzs=.jpeg)

![](assets/Nug_AX1ihM5f9kV2Ael7-0l8wX8kU0_5odDoQgkbJO8=.png)

![](assets/ZqBaL7Ooa-kpairJ8iwibowRMHWtyXX0kP55D86uEMc=.png)

### Batch Method

![](assets/yAmwh4DVM_YiTogHDsilHLImEWliH85375hC7PCnu9M=.png)

![](assets/tAWb2hBpHCMz8BNYtQOtif9BV1THVvGZ0TPxOu1emqc=.png)

![](assets/dtPLgMLsfIgTOJ7ZizLri2hsnmlGof6Del1qiDMhR4o=.png)

![](assets/i4_Hw-kPR6YLBqNsr5RO3ci_0go3YQF1TawHi2DT4XI=.png)

![](assets/z01ZQjPijiZRst9hg8deCJOoDenjGro906v6OAHgcZU=.png)

![](assets/D4HVqWB_INzIYRAtTP0Di1Ts3kUOX7iUlh_OuuScrFg=.png)

![](assets/xgdWRJc94FJOcGNdiDKLvSXENQRHqARvyBAkA6-Rn_c=.png)

![](assets/PZ-GFu72iKyIM4BUzRQ7lL_SJRFfjuME-hA3tsvpLvE=.png)

![](assets/xf6WDGP3h5xjmOI9jGGFr8o3-Q6XEJPyOdFQvlUzzhQ=.png)

![](assets/OfF2t9VSYykkQC8cQ3bAHXpKl-EgNTPT_0FBpad-qi4=.png)

![](assets/wChVDHkISNr7oGzoAW0UyG7ZyjsHPH6L8SpfJKLSmS4=.png)

![](assets/NiApkRTHphM1X1_ir2dzSa9qEW09ShLGaosBo_LQcBI=.png)
...
![](assets/H2Qb7BGPhwfZDCb_1H5_YPf70jtVfuOqycsAKMbUvG0=.png)

* Three broad families:

  ![](assets/koYShP-yWAPk8DpK3_8MVxs80aG_o503i2uVKr--sy0=.png)

![](assets/Vy-xKC_jMCszafjVc27RtDqtE0wSBaAL3x5jHTIdXrs=.png)

* state-action exploration / parameter exploration

### Multi-Armed Bandits

![](assets/ZgDcSVBkM0QrZoOnTUtoMi_CDHpDEZrypZp0zb7O18s=.png)
...
![](assets/uoBU2IONE5-HznH-2d3bKUELH0fECjzf2ecntSSH6S8=.png)

![](assets/kerQc3TJeJjV58vzWQNtQeDsGxfTm2hFugSyzmkE5_I=.png)

![](assets/KPv3pHhHeidGoY8BQMR3JcAABgnlCjtulqIuwIDBxTA=.png)

* not only initialize the value but also the count

![](assets/hk3_vK0L_udQ6403jxfjpPOmaT-9ZZMn4lzq9maPSzQ=.png)

![](assets/jP_jUMs58i85rR2r05SRl4iWCPdVUe_cfKcerk1pIm4=.png)

![](assets/tSAY4t1xq80KXpU7zmMk5KW8B6j06m-MJIggBHDm1N0=.png)

![](assets/tLGqBbLQYr8JQH7dv5oOU81txA2GAXdvlq4pw3acwWs=.png)

![](assets/OadhKA4zDjG15F4PeWYQkSz5kvHB5R-qJZuDcf1jzuI=.png)
